        ...
        projects: [
            {
                year: 2022, content: [
                    {
                        intro: `<strong>&lt;sans titre&gt;</strong>, un système no-code/low-code d'automatisation du design. <br>Tourne en partie avec <strong>ovo2</strong>, un petit langage fait pour ce projet.`,
        ...
        projects: [
            {
                year: 2022, content: [
                    {
                        intro: `<strong>&lt;to be named&gt;</strong>, a no-code/low-code design automation system. <br>Partly powered by <strong>ovo2</strong>, a small language made for this project.`,
                        tags: [tags.elixir, tags.typescript, tags.ovo2, tags.wip],
                    },
                    {
